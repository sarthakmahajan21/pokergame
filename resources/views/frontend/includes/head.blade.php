@if(Route::currentRouteName() == 'frontend.index')
    <title>{{ __('Poker') }} | {{ __('Bet and win crypto') }}</title>
@else
    <title>{{ __('Poker') }} | @yield('title')</title>
@endif
<!-- {{ config('app.version') }} -->
<meta charset="utf-8" />
...
<meta name="description" content="{{ __('Poker games') }}" />
...
<meta property="og:title" content="{{ __('Poker') }}" />
