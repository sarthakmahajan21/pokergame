<?php if(Route::currentRouteName() == 'frontend.index'): ?>
    <title><?php echo e(__('Poker')); ?> | <?php echo e(__('Bet and win crypto')); ?></title>
<?php else: ?>
    <title><?php echo e(__('Poker')); ?> | <?php echo $__env->yieldContent('title'); ?></title>
<?php endif; ?>
...
<meta name="description" content="<?php echo e(__('Poker games')); ?>" />
...
<meta property="og:title" content="<?php echo e(__('Poker')); ?>" />
