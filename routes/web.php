...
Route::get('admin/add-ons/{packageId}/enable', 'Backend\AddonController@enable')->name('addons.enable');
Route::get('admin/add-ons/{packageId}/disable', 'Backend\AddonController@disable')->name('addons.disable');
Route::get('admin/add-ons/{packageId}/install', 'Backend\AddonController@installShow')->name('addons.install.show');
